...
test.describe('Validate Safety Performance End Points - Response Clearance Times', () => {
  test("GET Clearance Time Monthly Filter", async ({ request, baseURL }) => {
  ...
  test("GET Clearance Time Month Yearly Filter", async ({ request, baseURL }) => {
  ...
  test("GET Clearance Time Weekly Filter", async ({ request, baseURL }) => {
  ...
  test("GET Clearance Time Daily Filter", async ({ request, baseURL }) => {
  ...
  test("GET Clearance Time Custom Filter", async ({ request, baseURL }) => {
