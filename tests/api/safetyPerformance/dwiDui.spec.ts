...
test.describe('Validate Safety Performance End Points - DWI/DUI Arrests', () => {
  test("GET DWI/DUI Arrests Monthly Filter", async ({ request, baseURL }) => {
  ...
  test("GET DWI/DUI Arrests Monthl Yearly Filter", async ({ request, baseURL }) => {
  ...
  test("GET DWI/DUI Arrests Weekly Filter", async ({ request, baseURL }) => {
  ...
  test("GET DWI/DUI Arrests Daily Filter", async ({ request, baseURL }) => {
  ...
  test("GET DWI/DUI Arrests Custom Filter", async ({ request, baseURL }) => {
