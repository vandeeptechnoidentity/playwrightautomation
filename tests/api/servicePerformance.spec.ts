...
test.describe('Validate Service Performance End Points', () => {
  test("GET Service Monthly", async ({ request, baseURL }) => {
  ...
  test("GET Service Yearly", async ({ request, baseURL }) => {
  ...
  test("GET Service Weekly", async ({ request, baseURL }) => {
  ...
  test("GET Service Daily Filter", async ({ request, baseURL }) => {
  ...
  test("GET Service Custom Filter", async ({ request, baseURL }) => {
