...
const basePath = '/finance-management/financial-performance';
let response;
let token;
...
test.describe('Validate Financial Performance End Points - Revenue', () => {
  test("GET FP Fiscal Year Filter", async ({ request, baseURL }) => {
  ...
  test("GET FP Yearly Filter", async ({ request, baseURL }) => {
  ...
  test("GET FP Custom Filter", async ({ request, baseURL }) => {
